...
### 定期换证书
#### 文档
1. https://u.sb/acme-sh-ssl/
2. https://github.com/acmesh-official/acme.sh/wiki/Blogs-and-tutorials#%E4%B8%AD%E6%96%87
```
# 签署证书
acme.sh --issue -d changediff.top  -w /data/nginx/changediff.top/
# 安装证书
acme.sh --install-cert -d changediff.top \
        --key-file /etc/nginx/cert/changediff.top.key \
        --fullchain-file /etc/nginx/cert/changediff.top.crt \
        --ca-file /etc/nginx/cert/changediff.top.ca.crt \
